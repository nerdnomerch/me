    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://linkedin.com/in/4andinugroho/', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://instagram.com/andiingrho_/', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/nerdnomerch/', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
        ...
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:andiinugroho@proton.me', "_self")
        }
