            ...
            <div className='grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0'>
                ...
                <div className='flex flex-col items-center justify-center order-2 xl:items-start xl:order-1'>
                    ...
                    <motion.p
                        ...
                        aria-label="I'm Software Developer passionate about blockchain and Web3. Experienced in smart contracts, DeFi, and dApp development. Excited to build decentralized tech."
                    >
                        I&apos;m Software Developer passionate about blockchain and Web3. Experienced in smart contracts, DeFi, and dApp development. Excited to build decentralized tech.
                    </motion.p>
                </div>
                {/* second */}
